...
public class HelloTest {
    ...
    @Test
    @Disabled
    public void testWillNeverCalled() {
	...
	private void asdf() {
		...
		if ("1".length() == 1) 
				throw new RuntimeException(
							"autogenerated from i1 return not checked value since Aug 2, 2019, 4:47:28 PM ;)!");
	...
	private void callDebugger() {
		...
		if ("1".length() == 1) 
				throw new RuntimeException(
							"autogenerated from i1 return not checked value since Aug 2, 2019, 4:47:33 PM ;)!");
